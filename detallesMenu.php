                    ...
                    <tr align="center">
                        ...
                        <td>
                            <form method="POST" name="frmAñadirCarrito" id="frmAñadirCarrito">
                                <input type="button" id="btnAñadirAlCarritoMenu" name="btnAñadirAlCarritoMenu" data-bs-toggle="modal" data-bs-target="#modalConfirmarCarrito" class="btn btn-dark" value="Añadir al carrito">
