<nav class="navbar navbar-dark navbar-expand bg-dark rounded-top" style="margin-top: 0.5%">
  ...
  <a id="iniciarSesion" class="navbar-brand" style="
            font-size: 14pt;
            text-align: center;
            font-family: 'FuentePrincipal';
          " href="iniciarSesion.php">
    <img id="iniciarSesionImagen" src="./imagenes/usuario.png" alt="" width="50px" height="50px" class="d-grid" />
    Acceso</a>
</nav>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse nav justify-content-center" id="navbarTogglerDemo03">
      <ul class="nav justify-content-center" style="font-size: 14pt">
        ...
        <li class="nav-item">
          <a id="listaNav" class="nav-link link-light" href="contacto.php" tabindex="-1" aria-disabled="true">Contacto</a>
        </li>
      </ul>
    </div>
  </div>
